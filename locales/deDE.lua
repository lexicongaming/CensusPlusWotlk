...
if ( GetLocale() == "deDE" ) then
	...
	CENSUSPLUS_BADLOCAL_1 = "Sie scheinen eine US-Volkszählungsversion zu haben, aber Ihre Lokalisierung ist auf Französisch, Deutsch, Spanisch, Italienisch, Koreanisch oder Russisch (Fuck Putin) eingestellt."
	CENSUSPLUS_BADLOCAL_2 = "Bitte laden Sie keine Daten auf WoWClassicPop.com hoch, bis dieses Problem gelöst ist."
	CENSUSPLUS_BADLOCAL_3 = "Wenn dies falsch ist, informieren Sie bitte Scarecr0w12 auf wowclassicpop.com über Ihre Situation, damit sie Korrekturen vornehmen können."
	...
	CENSUSPLUS_CMDERR_WHO2 = "/who Befehl sollte sein: who Name Level _ kein Name gefunden, Level ist optional"
	CENSUSPLUS_CMDERR_WHO2NUM = "who-Befehl kann sein: wer Name _ Name darf keine Nummer enthalten"
